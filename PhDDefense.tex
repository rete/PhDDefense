...
\addtobeamertemplate{navigation symbols}{}{%
  ...
  \framesubtitle{Le modèle standard}
    ...
    \begin{minipage}{0.46\linewidth}
      \begin{center}
        \begin{tikzpicture}
          ...
          \draw<2>[red, thick, overlay] (1.3,0.9) circle (0.4);
        \end{tikzpicture}
      \end{center}
      \vspace{-0.5cm}
    ...
    \end{minipage}
    \begin{tikzpicture}
      \draw<2>[red, thick, overlay, ->] (-0.45,4.9) -- (0.3,4.9) -- (0.3,-2.25) -- (-11,-2.25) -- (-11,-0.3) -- (-9.15,-0.3);
    \end{tikzpicture}
  \end{frame}
  ...
  \framesubtitle{Le collisionneur linéaire international - ILC}
    \begin{center}
      \includegraphics[width=0.65\linewidth]{figs/ilc_layout.png}
    \end{center}
    \begin{minipage}{0.51\linewidth}
      \begin{block}{Caractéristiques du collisionneur}
        \begin{itemize}
          ...
          \item Faisceaux polarisés : $e^-$ ($80\%$) - $e^+$ ($20\%$)
        \end{itemize}
      \end{block}
    \end{minipage} \hfill
    \begin{minipage}{0.46\linewidth}
      \begin{tikzpicture}
        ...
        \draw<2>[red, thick, overlay] (3.5,1.2) circle (1.3);
      \end{tikzpicture}
  ...
  \begin{minipage}{0.4\linewidth}
   ...
   \centering \includegraphics[width=\linewidth]{figs/sdhcal_testbeam.jpg}
  \end{minipage} ~~\hfill
...
\endgroup
  ...
  % \end{frame}
    ...
    \framesubtitle{\subsecname - architecture logicielle}
      ...
      \pause
      \begin{tikzpicture}
        \draw[red,  thick, overlay] (2.15,2.38) rectangle (3.6,3.27);
      ...
      \begin{block}{ArborPFA pour le détecteur ILD}
        \begin{itemize}
          ...
          \begin{itemize}
            ...
            \item Prise en compte du champs magnétique %$\vec{B}\neq\vec{0}$
          \end{itemize}
  ...
  \framesubtitle{\subsecname}
    ...
    \begin{block}{Surveillance de la qualité des données pour le SDHCAL}
      \begin{itemize}
        \item Un logiciel générique, DQM4HEP, à été développé. L'architecture a été présentée. Un effort particulier a été mis sur la \textbf{généricté du logiciel}
